  ...
  describe('createScheduleFromRows', () => {
    test('creates schedule from sample CSV data', () => {
      const sampleData = [
        ...
        ['1', 'secondary', 'Dumbbell reverse lunge', '4', '8', '35lbs - 50lbs', 'heavy'],
      ...
      // Check Day 1 workout
      const day1Workout = schedule.workouts.find(w => w.day === '1');
    ...
    test('creates schedule from actual sample.csv file', () => {
      ...
      const day1 = schedule.workouts.find(w => w.day === '1');
      const day2 = schedule.workouts.find(w => w.day === '2');  
      const day3 = schedule.workouts.find(w => w.day === '3');
      ...
      const seatedPress = day1!.exercises.primary!.find(e => 
        e.name === 'Seated Strict Press DB'
      );
